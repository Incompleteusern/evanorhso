    ...
    return (
      React.createElement("div", {className: "question"}, 
        ...
        React.createElement("ul", {className: "question-buttons"}, 
          React.createElement("li", null, React.createElement("button", {className: "btn btn-lg btn-default question-button-bigdata", onClick: this.selectBigDataAnswer}, "vEnhance Thumbnail")), 
          React.createElement("li", null, React.createElement("button", {className: "btn btn-lg btn-default question-button-pokemon", onClick: this.selectPokemonAnswer}, "HSO Post"))
        )
      )
    )
  }
